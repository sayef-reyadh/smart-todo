...
gantt
    ...
    Advanced Planning Features        :p2a, 2026-10-01, 45d
    Analytics + Import/Export         :p2b, after p2a, 25d
    Release 2                         :p2c, after p2b, 10d

    section Phase 3 - Collaboration
    Shared Workspaces                 :p3a, 2027-01-05, 40d
    Assignment/Comment Workflows      :p3b, after p3a, 30d
    Release 3                         :p3c, after p3b, 10d

    section Phase 4 - AI Assistant
    Recommendation Engine             :p4a, 2027-04-05, 45d
    Predictive Alerts                 :p4b, after p4a, 25d
    Release 4                         :p4c, after p4b, 10d
```
